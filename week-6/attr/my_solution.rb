...
* What are these methods doing?
  ** Initialize is simply a constructor for the Profile class.
  Print_info prints out the instance variables associated with the object
  . What_is_age/what_is_name/what_is_occupation will return the
  appropriate instance variables.
  Change_my_name/change_my_age/change_my_occupation will allow you to
...
* What changed between the last release and this release?
  ** An attribute reader was used to be able to read the value of age
  from outside the class.
* What was replaced?
  ** The old method for accessing age was removed in favor of an
  attribute reader.
* Is this code simpler than the last?
  ** This code is more standard than the last but not really any simpler.
   It will be more simple once we replace all of the getters/setters
   with attr.
* RELEASE 3 QUESTIONS
* What changed between the last release and this release?
  ** They added an attr_writer to provide write access to the age
  variable.
* What was replaced?
  ** The old method for updating the age was replaced with the
  attr_writer.
* Is this code simpler than the last?
  ** This code is more standard than the last but not really any simpler.
   It will be more simple once we replace all of the getters/setters
