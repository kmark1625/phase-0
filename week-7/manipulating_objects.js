...
* What tests did you have trouble passing? What did you do to make it pass? Why did that work?
  ** I didn't struggle with any of the tests. I followed the instructions one after another to complete the assignment.
* How difficult was it to add and delete properties outside of the object itself?
  ** It was easy to add new properties. You can simply add new properties with the dot notation and remove properties with delete.
* What did you learn about manipulating objects in this challenge?
  ** I learned adding new properties to JavaScript objects is very easy to do.
*/
// __________________________________________
