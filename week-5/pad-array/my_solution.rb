...
* Were you successful in breaking the problem down into small steps?
  * We were okay in breaking the problem down into small steps.  In the Pseudo-code, we had all the right steps however we could likely even break down our idea into even more concrete steps.
...
What difficulties and successes did you have?
  * We struggled a little bit to decide what the correct loop for the job was. Once we were able to decide this, things went very smoothly and the translation from pseudo-code was easy.
...
* When you refactored, did you find any existing methods in Ruby to clean up your code?
  * We discovered the fill method along with the dup method. Both of these methods helped to clean up our code significantly.
* How readable is your solution? Did you and your pair choose descriptive variable
names?
  * Our solution is fairly readable. Our refactored solution fits neatly on one line and the differences between the destructive vs non-destructive versions are made very clear.
* What is the difference between destructive and non-destructive methods in your own
words?
  * Destructive methods update the actual object being passed to it. Non-destructive methods will create a new object and return the new object.
=end