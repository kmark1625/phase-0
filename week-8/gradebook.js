...
I worked on this challenge Jeff George.
...
* What did you learn about adding functions to objects?
  ** I learned that when you add functions to objects you should be careful
  to have the appropriate commas before/after the function.
* How did you iterate over nested arrays in JavaScript?
  ** We iterated through the nested array by accessing the array with
  index/dot notation to grab the array and then iterated across it with a for
  loop.
* Were there any new methods you were able to incorporate? If so, what were
they and how did they work?
  ** We used reduce in order to sum all of the elements of the array.  Reduce allowed us to supply our own function that we wanted to apply to the array.
*/
// __________________________________________
